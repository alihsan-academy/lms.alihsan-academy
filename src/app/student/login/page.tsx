...
export default function StudentLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white font-sans">
      ...
      <div className="relative w-full md:w-1/2 h-[40vh] md:h-screen overflow-hidden bg-gradient-to-br from-green-50 to-green-100">
        {/* Decorative Background Elements */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-20 pointer-events-none">
          <div className="absolute -top-24 -left-24 w-96 h-96 rounded-full bg-green-400 blur-3xl"></div>
          <div className="absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full bg-blue-200 blur-3xl"></div>
        </div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center z-10">
          ...
          >
            {/* Logo */}
            <div className="bg-white/80 backdrop-blur-sm p-4 rounded-3xl shadow-lg mb-8 inline-block">
              <img 
            ...
            {/* Main Student Image */}
            <div className="relative w-full max-w-sm mb-8 drop-shadow-2xl">
              <img 
                src="/student_login_image.jpg" 
                alt="Student studying online"
                className="w-full h-auto object-contain rounded-2xl transform hover:scale-105 transition-transform duration-500"
              />
            </div>
            
            <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 drop-shadow-sm leading-tight tracking-tight">
              AL IHSAN ACADEMY <br/>
              <span className="text-xl md:text-2xl font-bold text-green-600 mt-2 block">Student Portal</span>
            </h1>
            <div className="w-16 h-1 bg-green-500 rounded-full mt-6 mb-4 opacity-80"></div>
