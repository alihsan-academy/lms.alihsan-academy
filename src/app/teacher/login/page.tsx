...
export default function TeacherLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white font-sans">
      ...
      <div className="relative w-full md:w-1/2 h-[40vh] md:h-screen overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100">
        {/* Decorative Background Elements */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-20 pointer-events-none">
          <div className="absolute -top-24 -left-24 w-96 h-96 rounded-full bg-blue-400 blur-3xl"></div>
          <div className="absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full bg-indigo-200 blur-3xl"></div>
        </div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center z-10">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 drop-shadow-sm leading-tight tracking-tight">
              AL IHSAN ACADEMY <br/>
              <span className="text-xl md:text-2xl font-bold text-indigo-600 mt-2 block">Teacher Portal</span>
            </h1>
            <div className="w-16 h-1 bg-indigo-500 rounded-full mt-6 mb-4 opacity-80"></div>
